...
def main():
    ...
    with col1:
        ...
        """, unsafe_allow_html=True)
        st.page_link("pages/1_📋_경매_절차_안내.py", label="👉 경매 절차 안내봇 이동", use_container_width=True)
    ...
    with col2:
        ...
        """, unsafe_allow_html=True)
        st.page_link("pages/2_📚_권리분석_튜터.py", label="👉 권리분석 튜터봇 이동", use_container_width=True)
    ...
    with col3:
        ...
        """, unsafe_allow_html=True)
        st.page_link("pages/3_📝_사례_퀴즈_연습.py", label="👉 사례 및 퀴즈 연습실 이동", use_container_width=True)
